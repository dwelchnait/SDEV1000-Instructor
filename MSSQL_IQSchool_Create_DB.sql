...
-- BATCHES
--  a batch is a collection of command to execute together
-- a batch starts at
--		a) the start of your physical file
--		b) after a previous go command
-- a batch ends with
--		a) the go command
--      b) the end of your physical file
...
(
	...
	Province			char(2)			Null 
										...
										Constraint CK_Student_Province_ZZ
											Check (Province like '[A-Za-z][A-Za-z]'),
	PostalCode			char(6)			Null
										Constraint CK_Student_PostalCode_Canadian_Style_Z9Z9Z9
											check(PostalCode like '[A-Za-z][0-9][A-Za-z][0-9][A-Za-z][0-9]'),
